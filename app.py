...
img_facial = Image.open(r"C:\Desktop\portfolio\images\facial-recog.jpeg").resize((500, 250))
img_pravah = Image.open(r"C:\Desktop\portfolio\images\pravah.png").resize((400, 270))
img_real_fake = Image.open(r"C:\Desktop\portfolio\images\images (2).jpeg").resize((400, 300))
...
with st.container():
    ...
    with right_column:
        ...
        profile_pic = Image.open(r"C:\Desktop\portfolio\images\profile.jpg").resize((300, 300))
